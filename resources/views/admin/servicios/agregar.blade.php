...
@section('content')
    ...
    <form id="form1" action="{{route('servicios.store')}}" method="POST" >
        @csrf
        <div class="row my-4">
            <div class="col">
        ...
        <div class="row my-4">
            <div class="col">
                <input type="text" name="tipo" class="form-control border border-secondary" placeholder="Tipo" required>
            </div>
            <div class="col">
                <input type="text" name="especificacion" class="form-control border border-secondary" placeholder="Especificación" required>
            </div>
        </div>
        <div class="row my-4">
            <div class="col">
