...
<a class="btn btn-primary " href="{{route('productos.create')}}">Agregar</a>
        ...
        <tbody>
			@foreach($productos as $producto)
				<tr>
					...
					<td>
						<form class="form-eliminar" action="{{route('productos.destroy',$producto->id)}}"  method="post" accept-charset="utf-8">
							@csrf
							@method('delete')
