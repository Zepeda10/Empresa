...
<a class="btn btn-primary " href="{{route('clientes.create')}}">Agregar</a>
        ...
        <tbody>
			@foreach($clientes as $cliente)
				<tr>
                    ...
                    <td>
						{{$cliente->num_exterior}}
					</td>
                    <td>
						{{$cliente->num_interior}}
					</td>
                    <td>
						{{$cliente->cod_postal}}
					</td>
					...
					<td>
						<form class="form-eliminar" action="{{route('clientes.destroy',$cliente->id)}}"  method="post" accept-charset="utf-8">
							@csrf
							@method('delete')
