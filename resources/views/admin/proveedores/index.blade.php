...
<a class="btn btn-primary " href="{{route('proveedores.create')}}">Agregar</a>
...
<table id="dtHorizontalExample" class="table table-striped table-bordered table-sm" cellspacing="0"
  width="100%">
        <thead>
            <tr>
                <th class="w-24">Id</th>
                <th class="w-48">Razón Social</th> 
                <th class="w-48">RFC</th> 
                <th class="w-24">Fecha Alta</th>
                <th class="w-24">Cumpleaños</th>
                <th class="w-24">Nombre Contacto</th>
                <th class="w-24">Puesto Contacto</th>
        ...
        <tbody>
			@foreach($proveedor as $prov)
				<tr>
                    ...
                    <td>
						{{$prov->celular_alterno}}
					</td>
                    <td>
						{{$prov->email}}
					</td>
                    <td>
						{{$prov->email_alternativo}}
					</td>
                    <td>
						{{$prov->id_domicilio}}
					</td>
					...
					<td>
						<form class="form-eliminar" action="{{route('proveedores.destroy',$prov->id)}}"  method="post" accept-charset="utf-8">
							@csrf
							@method('delete')
